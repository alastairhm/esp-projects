...
void loop() {
  // Perform a scan every 12 seconds
  ...
  for (scrollIndex = 0; scrollIndex < networksFound; scrollIndex++) {
    drawList();
    delay(1500);  // Time each page stays visible
  }
